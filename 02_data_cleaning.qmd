...
Okay, that's far too many to display in a table, but the code below  displays them all so that I can visually inspect the different types and develop a categorisation system:
```{r}
data_w_languages %>%
