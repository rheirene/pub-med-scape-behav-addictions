...
# US unis:
 str_detect(institution, "(?i)Columbia University") ~ "New York",
str_detect(institution, "(?i)Russell J. Jandoli School") ~ "Olean",
...
str_detect(institution, "(?i)Kim Ross is the School
") ~ "Pheonix",
...
str_detect(institution, "(?i)St Bonaventure University") ~ "New York",
...
str_detect(institution, "(?i)CQ University") ~ "Rockhamptom", 
...
# Turkey:
str_detect(institution, "(?i)Inonu University") ~ "Malatya",
...
str_detect(institution, "(?i)Sahar Obeid") ~ "Beirut", # This is an author I looked up
# Random:
...
str_detect(institution, "(?i)Rochester, MN") ~ "USA",
 str_detect(institution, "(?i)Jacksonville, FL") ~ "USA",
...
str_detect(institution, "(?i)Federal University of Minas") ~ "Brazil",
    ...
    str_detect(institution, "(?i)Universidade Federal de Minas Gerais") ~ "Brazil",
...
# Newark Beacon Innovation Centre:
 str_detect(institution, "(?i)Newark Beacon Innovation Centre") ~ "UK",
  ...
  str_detect(institution, "(?i)University of New South Wales") ~ "Sydney",
...
filter(countries_of_authors != country.etc) %>% # Identify and isolate mismatches
  ...
  print(n = 700) # Okay, happy theses are good (after 10+ rounds of filtering)
...
# Now look at papers where we couldn't match the country but linking the world.cities dataset connects a country with a city. Error check this:
 ...
 # 2025-05-04: started with 814 and now checked up to around 500 
