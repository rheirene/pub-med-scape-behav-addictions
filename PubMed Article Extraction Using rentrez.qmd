...
Label_Pornography <- rep("pornography", times = count(results_pornography2))
...
**Actual search used:** "Tanning addiction"[Title/Abstract]
-   Not found so removed from search terms: "Addicted to tanning"[Title/Abstract] AND "Tanning disorder"[Title/Abstract]
