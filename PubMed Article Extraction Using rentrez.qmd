...
**Notes pre-search:** No available MeSH terms. The simple phrase "joy riding addiction" seems to be most commonly used. Adding in the [Title/Abstract] filter resulted in no results and so it was removed.
...
- 
**Notes post-search:** I manually inspected all of the results returned on PubMed. Only 3 studies are returned andto appear relevant. The one irrelevant study is listed below:
