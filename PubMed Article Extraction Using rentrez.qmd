...
Label <- rep("cybersex", times = count(results_cybersex2))

results_cybersex_final <- results_cybersex2 %>% bind_cols(Label) %>%
  rename(Label = 14) %>%
  print()
...
Label <- rep("sex", times = count(results_sex2))

results_sex_final <- results_sex2 %>% bind_cols(Label) %>%
  rename(Label = 14) %>%
  print()
