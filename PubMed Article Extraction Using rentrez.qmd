...
**Manual search results:** [link](https://pubmed.ncbi.nlm.nih.gov/28914072/)
...
```{r warning=FALSE, message=FALSE}
# Add search URL:
url_YouTube_rvest <- "https://pubmed.ncbi.nlm.nih.gov/?term=YouTube+addiction&size=200" # 1 results returned on 20/08/2023
