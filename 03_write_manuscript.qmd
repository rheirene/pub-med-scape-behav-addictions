...
While the addition of Gambling Disorder to the DSM-5 appears to have been widely accepted as a positive step forward, the addition of Gaming Disorder to the ICD-11 has been met with contention. BEAN ET AL\> and key points in this debate.
...
Whilst concern has been expressed about the form of "concept creep" occurring in the behavioural addictions field \[e.g., @Billieux2015\], there has been no attempt to systematically investigate this trend and "take stock" of research in the field. The number of novel addictions formally investigated remains unclear. As does the extent to which each purported addiction has been studied relative to the more established gambling and gaming disorders. **WHY IS THIS AN ISSUE. This precludes.... and...** The aim of this bibliographic review was, therefore, to:
